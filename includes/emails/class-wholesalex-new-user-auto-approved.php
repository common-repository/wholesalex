 ...
 * @extends     WC_Email
 */
class WholesaleX_New_User_Auto_Approved_Email extends WC_Email {
	...
	public function __construct() {
		$this->id             = 'wholesalex_new_user_auto_approve';
		$this->customer_email = true;
		$this->title          = __( 'WholesaleX: New User (Auto Approved)', 'wholesalex' );
	...
	public function get_default_subject() {
		return __( 'Your {site_title} account successfully created!', 'wholesalex' );
	}
	...
	public function get_default_heading() {
		return __( 'Welcome to {site_title}', 'wholesalex' );
	}
...
return new WholesaleX_New_User_Auto_Approved_Email();
