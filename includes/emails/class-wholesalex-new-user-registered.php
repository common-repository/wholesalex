 ...
 * @extends     WC_Email
 */
class WholesaleX_Admin_New_User_Notification_Email extends WC_Email {
	...
	public function __construct() {
		$this->id            = 'wholesalex_new_user_registered';
		$this->title         = __( 'WholesaleX: New User Registered', 'wholesalex' );
	...
	public function get_default_subject() {
		return __( 'A New User Has been registered', 'wholesalex' );
	}
	...
	public function trigger( $user_id, $user_pass = '', $password_generated = false ) {
		...
		do_action( 'wholesalex_before_new_user_registered_notification_email_trigger', $user_id );
...
return new WholesaleX_Admin_New_User_Notification_Email();
