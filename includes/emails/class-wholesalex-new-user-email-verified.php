 ...
 * @extends     WC_Email
 */
class WholesaleX_New_User_Verified_Email extends WC_Email {
	...
	public function __construct() {
		$this->id             = 'wholesalex_new_user_email_verified';
		$this->customer_email = true;
		$this->title          = __( 'WholesaleX: Email Verified', 'wholesalex' );
	...
	public function get_default_subject() {
		return __( 'Congratulations! Your Account is Now Verified and Approved', 'wholesalex' );
	}
...
return new WholesaleX_New_User_Verified_Email();
