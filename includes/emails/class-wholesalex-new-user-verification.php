 ...
 * @extends     WC_Email
 */
class WholesaleX_New_User_Verification_Email extends WC_Email {
	...
	public function __construct() {
		...
		$this->id             = 'wholesalex_new_user_email_verification';
		$this->title          = __( 'WholesaleX: Email Verification', 'wholesalex' );
	...
	public function get_default_subject() {
		return __( 'Account Registration Confirmation - Action Required', 'wholesalex' );
	}
...
return new WholesaleX_New_User_Verification_Email();
