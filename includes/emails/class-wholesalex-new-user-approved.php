 ...
 * @extends     WC_Email
 */
class WholesaleX_New_User_Approved_Email extends WC_Email {
	...
	public function __construct() {
		$this->id             = 'wholesalex_new_user_approved';
		$this->customer_email = true;
		$this->title          = __( 'WholesaleX: Registration Approve', 'wholesalex' );
...
return new WholesaleX_New_User_Approved_Email();
